...
if(!window.pdfjsWebApp){
let pdfjsWebApp, pdfjsWebAppOptions;
}
if (typeof PDFJSDev !== 'undefined' && PDFJSDev.test('PRODUCTION')) {
    pdfjsWebApp = require('/eXoWCMResources/pdf.js/web/app.js');
    pdfjsWebAppOptions = require('/eXoWCMResources/pdf.js/web/app_options.js');
}
...
function webViewerLoad() {
  ...
  if (typeof PDFJSDev === 'undefined' || !PDFJSDev.test('PRODUCTION')) {
    Promise.all([
      ...
      appOptions.AppOptions.set('defaultUrl', filename.filenamepath);
    ...
    if (typeof PDFJSDev !== 'undefined' && PDFJSDev.test('CHROME')) {
      var filename = getfilename();
      pdfjsWebAppOptions.AppOptions.set('defaultUrl', filename.filenamepath);
    }
