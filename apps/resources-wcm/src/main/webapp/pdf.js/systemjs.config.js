...
(function () {
  function getSyncScriptParams() {
         var scriptName = document.getElementById('myscript');
         return {
             base_url : scriptName.getAttribute('base_url')
         };
 };
  var baseLocation;
  if (typeof document !== 'undefined') {
	  var base_url = getSyncScriptParams();
	  console.log('url = ',base_url.base_url);
    baseLocation = new URL('/eXoWCMResources/pdf.js/', base_url.base_url);
    console.log("base url = ",baseLocation);
